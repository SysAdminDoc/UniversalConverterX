...
- **v2.21+** — first-party FFmpeg shims such as `audio-compressor/sidecar.py`, `voice-changer/sidecar.py`, and `slideshow/sidecar.py` use the same NDJSON runner for local media processing workflows.
