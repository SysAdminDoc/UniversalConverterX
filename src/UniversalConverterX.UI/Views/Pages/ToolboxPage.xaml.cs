...
public sealed partial class ToolboxPage : Page
{
    ...
    private void SeedTiles()
    {
        ...
        VideoTools.Add(new ToolboxTile("presets:av1an", "Av1an Parallel Encode", "Per-scene parallel AV1 / VP9 / H.264 / H.265 encoding with resume", "\uE714", blue, "Ready", green, false, "Av1an + VapourSynth"));
        VideoTools.Add(new ToolboxTile("presets:vapoursynth", "VapourSynth Scripts", "Inspect, graph, or render explicitly trusted local .vpy scripts", "\uE943", blue, "Ready", green, false, "VSPipe + FFmpeg"));
        ...
        // Disc
        DiscTools.Add(new ToolboxTile("disc-burn", "Disc Burner", "Create ISO images or burn data CD/DVD, DVD-Video, and single-title Blu-ray media", "\uE958", red, "Ready", green, false, "Windows IMAPI2 + dvdauthor + tsMuxeR"));
