...
- **Premium polish pass:** tightened the shared visual system, readiness/trust language, Toolbox state semantics, AI roadmap transparency, placeholder recovery actions, and Settings save/discard confidence.
