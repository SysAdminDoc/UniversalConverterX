...
- **Highest remaining GUI gaps:** real media preview panes, persistent job history, before/after quality comparisons, per-file output overrides, GPU/hardware acceleration visibility, guided solution presets, AI model cache management, and richer partial-success recovery.
