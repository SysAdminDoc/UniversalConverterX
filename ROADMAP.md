...
- **Highest remaining GUI gaps:** real media preview panes, "Finished" queue/history tabs, before/after quality comparisons, output-folder controls per job, GPU/hardware acceleration visibility, guided solution presets, AI model cache management, and clearer partial-success recovery.
